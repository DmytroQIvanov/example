...
export const VALIDATE_PERSON_ELECTRONIC = gql`
  mutation validate_person_electronic($id: Int!, $date: timestamp) {
    update_person_electronic_by_pk(
      pk_columns: { person_electronic_id: $id }
...
export const UPDATE_PERSON_ELECTRONIC = gql`
  mutation update_person_electronic(
    $id: Int!
    $email: String!
    $electronictype: Int!
    $source: Int!
