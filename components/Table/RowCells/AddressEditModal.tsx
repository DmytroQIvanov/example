      ...
      <Box sx={{ flexGrow: 1 }} className={classes.addressModal}>
              ...
              <React.Fragment>
                <form className="flex" onSubmit={handleSubmit}>
                  <div className="MuiFormControl-root MuiTextField-root makeStyles-fullWidth-6 css-1u3bzj6-MuiFormControl-root-MuiTextField-root full-width">
                    ...
                    >
                      <div
                        className="MuiOutlinedInput-root MuiInputBase-root MuiInputBase-colorPrimary MuiInputBase-formControl css-9ddj71-MuiInputBase-root-MuiOutlinedInput-root full-width">
                        <input
                          ref={inputEl}
                          type="text"
        ...
        <Grid container spacing={2} className={classes.section}>
          ...
          <Grid item xs={2} className={classes.addressModalAction}>
            ...
            <div>
              <Button variant="contained" color="primary" onClick={onSave} className={classes.saveBtn}>
                Save
              </Button>
            </div>
          </Grid>
