    ...
    return (
        <div className={collapsed ? 'sidebar close' : 'sidebar open'}>
            ...
            <ul className="nav-links">
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/interactions')}>
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/locations')}>
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/phones')}>
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/othernames')}>
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/submissions')}>
                            <FaSuitcase className="react-icon" />
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/research')}>
                            <FaSuitcase className="react-icon" />
                ...
                <li>
                    <div className="iocn-link">
                        <a href="#" onClick={(e) => goTo(e, '/persondataentry/campusaffiliations')}>
                            <FaSuitcase className="react-icon" />
